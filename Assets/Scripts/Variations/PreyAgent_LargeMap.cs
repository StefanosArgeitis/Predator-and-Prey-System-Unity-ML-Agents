...
public class PreyAgent_LargeMap : Agent
{
    [SerializeField] private Transform _food;
    [SerializeField] private PredatorAgent_LargeMap _predatorAgent;
    ...
    private void SpawnFood()
    {
        ...
        float randomZ = Random.Range(-29f, 29f);
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            randomX = Random.Range(-29f, 29f);
            randomZ = Random.Range(-29f, 29f);
            spawnPos = new Vector3(randomX, 0.5f, randomZ);
        }
